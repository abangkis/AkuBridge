...
**`0.7.3.0`** / runtime **`source-adapters-v81`**.
...
flowchart LR
    ...
    DOM --> FA["Facebook adapter<br/>facebook-dom-v14<br/>feed posts only"]
...
`0.7.3` distribution path on Windows and macOS; the preview does not
